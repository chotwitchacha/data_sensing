...
const columns = [
      ...
      customBodyRender: (value) => {
        return (
          <Typography component={'span'} noWrap={false}>
            ...
            <span>, Color: </span>
            <span style={{ fontWeight: 'bold' }}>{value.color}</span>
          </Typography>
        );
      },
    },
  ...
  {
    name: 'month_of_sale_out',
    label: 'Month of Sale out',
    options: {
      filter: true,
      sort: false,
      customBodyRender: (value) => {
