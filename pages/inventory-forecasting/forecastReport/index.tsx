...
const columns = [
  ...
  {
    name: "expected_replenishment_stock",
    label: 'Expected Replenishment Stock',
    options: {
      filter: true,
      sort: false,
      customBodyRender: (value) => {
    ...
    value: 'expected_replenishment_stock'
  },
  {
    name: "estimate_time_of_departure ",
    ...
    value: 'Estimate Time Of Departure '
  },
  {
    name: "estimate_time_of_arrival",
    ...
    value: 'estimate_time_of_arrival'
  },
  {
    name: "expected_reorder_date",
    label: 'Expected Reorder Date',
    options: {
      filter: true,
      sort: false,
      customBodyRender: (value) => {
