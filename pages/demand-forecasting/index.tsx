...
import { DemandDashboards, DashboardDemandFilter } from '@components/Component'
...
const damandForecasting = ({ trendData, storeData, groupData, classChartData, brandData, filterApiRes }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  ...
  return (
    ...
    >
      <DemandDashboards
        ...
        trendData={trendDataIn}
        storeData={storeDataIn}
        groupData={groupDataIn}
        classChartData={classChartDataIn}
        brandData={brandDataIn}
...
export default damandForecasting
