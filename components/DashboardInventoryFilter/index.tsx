...
import { useStyles } from './DashboardInventoryFilter.style'
...
const DashboardInventoryFilter = ({ startDate, endDate, resetFunc, getData, disbleButton, filterList }: IPropsFilter) => {
...
export default DashboardInventoryFilter