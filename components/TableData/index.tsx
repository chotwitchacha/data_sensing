...
import { useStyles } from './TableData.style'
...
const TableData = ({ title, TableDataList, columns, HeaderElements, pagination, tableActionUpdate, Filters, getMuiTheme, tableId }: IPropsTableData) => {
